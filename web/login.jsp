    ...
    <div class="row box_login">
        <form class="login_content">
            ...
            <div class="first_row clearfix">
                <input class="input_name" type="text" placeholder="用户名">
            </div>
            <div class="pwd clearfix">
                <input class="input_pwd" type="password" placeholder="密码">
            </div>
            <div class="clearfix">
            ...
            <div class="clearfix">
                <button class="btn btn-blue" onclick="window.open('index.html')">登录</button>
            </div>
        </form>
    </div>
